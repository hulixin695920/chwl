...
class BaseModel extends Model
{
    ...
    public function getOne($columns = null, $where = null, $order = null, $group = null)
    {
        ...
        //PDO强类型转换
        if ($this->connection == 'mysql' && !empty($this->intFilterColumns)) {
